...
import ContextDropdown from "./components/ContextDropdown/ContextDropdown.jsx";
	...
	return (
		<main>
			<section className={styles.landingspace}>
				...
				/>
				<BottomSVG
					style="bottom: 0; left:6%; width: 54vw;"
					className={styles.svgshapes}
				/>
			</section>
			...
			>
				...
				<p>
					Just three entries of your choice will combine into your secure
					password.
				</p>
				<br />
				<form
					...
					<ContextDropdown
						message={
							<p>
								...
								used in passwords, making it easier to crack. If you can't
								imagine not using it, it'll be okay to use.
							</p>
						}
					></ContextDropdown>
